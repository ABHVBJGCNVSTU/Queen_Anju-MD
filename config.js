...
module.exports = {
SESSION_ID: process.env.SESSION_ID ||"TZdylCaI#_lEzYWYthE-XML6Tw-jf1knaK_7VpMF5XCkCzbD2d_g",
ALIVE_IMG: process.env.ALIVE_IMG || "https://telegra.ph/file/adc46970456c26cad0c15.jpg",
ALIVE_MSG: process.env.ALIVE_MSG || "HELLOW THEIR, MIAN AMIR IS ALIVE...\n\nOWNER: Mian-Amir\n\nTHANKS FOR USING MIAN AMIR\n\n> *© Qᴜᴇᴇɴ ᴀɴᴊᴜ ᴡʜᴀᴛꜱᴀᴘᴘ ʙᴏᴛ - ᴍᴅ*/n/n*> ɢɪᴛʜᴜʙ :* github.com/Mrrashmika/Queen_Anju-MD",
AUTO_READ_STATUS: process.env.AUTO_READ_STATUS || "true",
MODE: process.env.MODE || "public",
BOT_NUMBER: process.env.BOT_NUMBER || "923114397148",
